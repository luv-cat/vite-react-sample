...
function it(e, t, o, l) {
    let i = o.reduce(
        (n, r) => (Object.prototype.hasOwnProperty.call(n, r.position) || (n[r.position] = []), n[r.position].push(r), n),
        {},
    )
    i.top && E(e, t, i.top, l),
        ...
        return (
            ...
            W(() => {
                ...
                return (
                    t.viewMode === 'story' &&
                        o &&
                        (document.addEventListener('pointerover', l), K(), window.addEventListener('resize', i), H(v.x, v.y)),
                    () => {
