    ...
    function a() {
        ...
        for (const [u, i] of Object.entries(l)) {
            for (const [s, d] of Object.entries(i))
                (l[s] = { open: `\x1B[${d[0]}m`, close: `\x1B[${d[1]}m` }), (i[s] = l[s]), o.set(d[0], d[1])
        ...
        return (
            ...
            Object.defineProperties(l, {
                rgbToAnsi256: {
                    value: (u, i, s) =>
                        u === i && i === s
                            ...
                            : 16 + 36 * Math.round((u / 255) * 5) + 6 * Math.round((i / 255) * 5) + Math.round((s / 255) * 5),
                    enumerable: !1,
                },
                hexToRgb: {
                    value: (u) => {
                ...
                hexToAnsi256: { value: (u) => l.rgbToAnsi256(...l.hexToRgb(u)), enumerable: !1 },
            }),
            l
        )
    }
...
function qy(e, t, r, n, a, o, l = ': ') {
    ...
    if (!i.done) {
        ...
        for (; !i.done; ) {
            ...
            ;(u += s + d + l + f), (i = e.next()), i.done ? t.min || (u += ',') : (u += ',' + t.spacingInner)
        }
        u += t.spacingOuter + r
    }
    return u
...
function Ay(e, t, r, n, a, o) {
    ...
    if (!u.done) {
        ...
        const i = r + t.indent
        for (; !u.done; )
            (l += i + o(u.value, t, i, n, a)), (u = e.next()), u.done ? t.min || (l += ',') : (l += ',' + t.spacingInner)
        l += t.spacingOuter + r
    }
    return l
}
function xy(e, t, r, n, a, o) {
    ...
    if (e.length) {
        ...
        for (let i = 0; i < e.length; i++)
            (l += u), i in e && (l += o(e[i], t, u, n, a)), i < e.length - 1 ? (l += ',' + t.spacingInner) : t.min || (l += ',')
        l += t.spacingOuter + r
    }
    return l
}
    ...
    if (u.length) {
        ...
        for (let s = 0; s < u.length; s++) {
            const d = u[s],
                f = o(d, t, i, n, a),
                p = o(e[d], t, i, n, a)
            ;(l += i + f + ': ' + p), s < u.length - 1 ? (l += ',' + t.spacingInner) : t.min || (l += ',')
        }
        l += t.spacingOuter + r
    }
    return l
...
const By = typeof ml == 'function' && ml.for ? ml.for('jest.asymmetricMatcher') : 1267621,
    hr = ' ',
    Pd = (e, t, r, n, a, o) => {
        const l = e.toString()
        return l === 'ArrayContaining' || l === 'ArrayNotContaining'
            ...
            ? ++n > t.maxDepth
                ? '[' + l + ']'
                : l + hr + '{' + (0, ts.printObjectProperties)(e.sample, t, r, n, a, o) + '}'
            : l === 'StringMatching' || l === 'StringNotMatching' || l === 'StringContaining' || l === 'StringNotContaining'
...
const Fy = ' ',
    ...
    qd = (e) => e && e.constructor && !!e.constructor.name && Vy(e.constructor.name)
je.test = qd
                  ...
                  (Td.indexOf(l) !== -1
                      ? '{' +
                        (0, rs.printObjectProperties)(
                            Hy(e) ? Array.from(e).reduce((u, i) => ((u[i.name] = i.value), u), {}) : { ...e },
                            t,
                            r,
                            n,
                            a,
...
V.printText = V.printProps = V.printElementAsLeaf = V.printElement = V.printComment = V.printChildren = void 0
var xd = Gy(Zi)
function Gy(e) {
    return e && e.__esModule ? e : { default: e }
}
...
`) !== -1 && (f = r.spacingOuter + u + f + r.spacingOuter + n),
                    (f = '{' + f + '}')),
                r.spacingInner + n + i.prop.open + s + i.prop.close + '=' + i.value.open + f + i.value.close
            )
        })
        .join('')
}
V.printProps = Yy
const Jy = (e, t, r, n, a, o) => e.map((l) => t.spacingOuter + r + (typeof l == 'string' ? Md(l, t) : o(l, t, r, n, a))).join('')
V.printChildren = Jy
const Md = (e, t) => {
...
const em = 1,
    ...
    Nd = (e) => {
        var t
        return (e == null || (t = e.constructor) === null || t === void 0 ? void 0 : t.name) && nm(e)
    }
Ne.test = Nd
function am(e) {
...
const Dd = (e, t, r, n, a, o) => {
    ...
    return ++n > t.maxDepth
        ...
        : (0, ut.printElement)(
              ...
              (0, ut.printProps)(
                  bl(e)
                      ...
                      : Array.from(e.attributes)
                            .map((u) => u.name)
                            .sort(),
                  bl(e) ? {} : Array.from(e.attributes).reduce((u, i) => ((u[i.name] = i.value), u), {}),
                  t,
                  r + t.indent,
                  n,
                  a,
              ...
              (0, ut.printChildren)(Array.prototype.slice.call(e.childNodes || e.children), t, r + t.indent, n, a, o),
              t,
              r,
          )
}
...
const um = '@@__IMMUTABLE_ITERABLE__@@',
    ...
    as = '…',
    mm = (e, t, r, n, a, o, l) =>
        ++n > t.maxDepth ? un(gt(l)) : gt(l) + Ht + '{' + (0, Vt.printIteratorEntries)(e.entries(), t, r, n, a, o) + '}'
function bm(e) {
    let t = 0
    return {
        next() {
...
const hm = (e, t, r, n, a, o) => {
        ...
        return ++n > t.maxDepth ? un(l) : l + Ht + '{' + (0, Vt.printIteratorEntries)(bm(e), t, r, n, a, o) + '}'
    },
    gm = (e, t, r, n, a, o) => {
        const l = gt('Seq')
        return ++n > t.maxDepth
            ? un(l)
            : e[cm]
            ? l + Ht + '{' + (e._iter || e._object ? (0, Vt.printIteratorEntries)(e.entries(), t, r, n, a, o) : as) + '}'
            : l +
              Ht +
              '[' +
    ...
    hl = (e, t, r, n, a, o, l) =>
        ++n > t.maxDepth ? un(gt(l)) : gt(l) + Ht + '[' + (0, Vt.printIteratorValues)(e.values(), t, r, n, a, o) + ']',
    kd = (e, t, r, n, a, o) =>
        e[dm]
...
const Nm = typeof gl == 'function' && gl.for ? gl.for('react.test.json') : 245830487,
    Dm = (e) => {
        const { props: t } = e
        return t
            ? Object.keys(t)
    ...
    Xd = (e, t, r, n, a, o) =>
        ++n > t.maxDepth
            ...
            : (0, Er.printElement)(
                  e.type,
                  e.props ? (0, Er.printProps)(Dm(e), e.props, t, r + t.indent, n, a, o) : '',
                  e.children ? (0, Er.printChildren)(e.children, t, r + t.indent, n, a, o) : '',
                  t,
                  r,
              )
Le.serialize = Xd
...
const tf = Object.prototype.toString,
    ...
    El = (e) => (typeof e.constructor == 'function' && e.constructor.name) || 'Object',
...
function af(e, t, r, n, a, o) {
    ...
    const l = ++n > t.maxDepth,
        u = t.min
    if (t.callToJSON && !l && e.toJSON && typeof e.toJSON == 'function' && !o) return $e(e.toJSON(), t, r, n, a, !0)
    const i = tf.call(e)
    return i === '[object Arguments]'
        ? l
            ? '[Arguments]'
            : (u ? '' : 'Arguments ') + '[' + (0, Mt.printListItems)(e, t, r, n, a, $e) + ']'
        : eb(i)
        ? l
            ? '[' + e.constructor.name + ']'
            : (u || (!t.printBasicPrototype && e.constructor.name === 'Array') ? '' : e.constructor.name + ' ') +
              '[' +
        ...
        ? l
            ? '[Map]'
            : 'Map {' + (0, Mt.printIteratorEntries)(e.entries(), t, r, n, a, $e, ' => ') + '}'
        : i === '[object Set]'
        ? l
            ? '[Set]'
...
` + i,
    ...
    if (typeof l != 'string')
        throw new Error(`pretty-format: Plugin must return type "string" but instead returned "${typeof l}".`)
    return l
}
function lf(e, t) {
...
const ru = { comment: 'gray', content: 'reset', prop: 'yellow', tag: 'cyan', value: 'green' },
    uf = Object.keys(ru),
    ae = {
        callToJSON: !0,
        compareKeys: void 0,
...
function ab(e) {
    if (
        (Object.keys(e).forEach((t) => {
            if (!ae.hasOwnProperty(t)) throw new Error(`pretty-format: Unknown option "${t}".`)
        }),
...
const ob = (e) =>
        uf.reduce((t, r) => {
            ...
            else throw new Error(`pretty-format: Option "theme" has a key "${r}" whose value "${n}" is undefined in ansi-styles.`)
            return t
        }, Object.create(null)),
    lb = () => uf.reduce((e, t) => ((e[t] = { close: '', open: '' }), e), Object.create(null)),
    cf = (e) => (e && e.printFunctionName !== void 0 ? e.printFunctionName : ae.printFunctionName),
    df = (e) => (e && e.escapeRegex !== void 0 ? e.escapeRegex : ae.escapeRegex),
    ff = (e) => (e && e.escapeString !== void 0 ? e.escapeString : ae.escapeString),
    cs = (e) => {
        var t
        return {
            callToJSON: e && e.callToJSON !== void 0 ? e.callToJSON : ae.callToJSON,
            colors: e && e.highlight ? ob(e) : lb(),
            compareKeys: e && typeof e.compareKeys == 'function' ? e.compareKeys : ae.compareKeys,
            escapeRegex: df(e),
            escapeString: ff(e),
            indent: e && e.min ? '' : ib(e && e.indent !== void 0 ? e.indent : ae.indent),
...
function oe(e, t) {
    ...
    if (typeof t < 'u' && !ds(t)) throw new TypeError('Array.from: when provided, the second argument must be a function')
    for (var a = vb(n.length), o = ds(r) ? Object(new r(a)) : new Array(a), l = 0, u; l < a; )
...
function Pb(e, t) {
    return [
        ...
        var n
        return e.hasAttribute(r) && !((n = Rb[t]) !== null && n !== void 0 && n.has(r))
    })
}
function yf(e, t) {
    return Pb(e, t)
...
function Fb(e) {
    return $b(e) ? e.selectedOptions || ps(e, '[selected]') : ps(e, '[aria-selected="true"]')
}
function Ub(e) {
    ...
    function p(v, b) {
        ...
        if (
            (y.forEach(function (I) {
                var c = S(I, { isEmbeddedInLabel: b.isEmbeddedInLabel, isReferenced: !1, recursion: !0 }),
    ...
    function R(v) {
        ...
        if (xb(v)) {
            ...
            for (var b = oe(v.childNodes), P = 0; P < b.length; P += 1) {
                var w = b[P]
                if (Mb(w)) return S(w, { isEmbeddedInLabel: !1, isReferenced: !1, recursion: !1 })
            }
        } else if (Tb(v)) {
            r.add(v)
            for (var O = oe(v.childNodes), y = 0; y < O.length; y += 1) {
                var h = O[y]
                if (mf(h)) return S(h, { isEmbeddedInLabel: !1, isReferenced: !1, recursion: !1 })
            }
        } else if (jb(v)) {
            r.add(v)
        ...
        if (qr(v) && (v.type === 'button' || v.type === 'submit' || v.type === 'reset')) {
            var K = m(v, 'value')
            if (K !== null) return K
        ...
        if (ce !== null && ce.length !== 0)
            return (
                ...
                oe(ce)
                    .map(function (yl) {
                        return S(yl, { isEmbeddedInLabel: !0, isReferenced: !1, recursion: !0 })
                    })
                    .filter(function (yl) {
                        return yl.length > 0
                    })
    ...
    function S(v, b) {
        ...
        if (o === 'name' && !b.isReferenced && w.length > 0)
            return (
                ...
                w
                    .map(function (z) {
                        return S(z, { isEmbeddedInLabel: b.isEmbeddedInLabel, isReferenced: !0, recursion: !1 })
                    })
                    .join(' ')
            )
        ...
        if (O || b.isEmbeddedInLabel || b.isReferenced) {
            if (he(v, ['combobox', 'listbox'])) {
                ...
                return E.length === 0
                    ...
                    : oe(E)
                          .map(function (z) {
                              return S(z, { isEmbeddedInLabel: b.isEmbeddedInLabel, isReferenced: !1, recursion: !0 })
                          })
                          .join(' ')
            }
            if (bf(v, 'range'))
        ...
        if (Hb(v) || (B(v) && b.isReferenced) || Vb(v) || Wb()) {
            var I = p(v, { isEmbeddedInLabel: b.isEmbeddedInLabel, isReferenced: !1 })
            if (I !== '') return r.add(v), I
        }
        if (v.nodeType === v.TEXT_NODE) return r.add(v), v.textContent || ''
        if (b.recursion) return r.add(v), p(v, { isEmbeddedInLabel: b.isEmbeddedInLabel, isReferenced: !1 })
        var c = C(v)
        return c !== null ? (r.add(v), c) : (r.add(v), '')
    }
    return Db(S(e, { isEmbeddedInLabel: !1, isReferenced: o === 'description', recursion: !1 }))
}
function zt(e) {
    '@babel/helpers - typeof'
    return (
...
function bh(e, t) {
    var r = (typeof Symbol < 'u' && e[Symbol.iterator]) || e['@@iterator']
    if (!r) {
        if (Array.isArray(e) || (r = Pf(e)) || (t && e && typeof e.length == 'number')) {
            r && (e = r)
            var n = 0,
                a = function () {}
            return {
...
var dg = {
        ...
        prohibitedProps: [],
        props: {},
        relatedConcepts: [{ concept: { constraints: ['direct descendant of document'], name: 'header' }, module: 'HTML' }],
        requireContextRole: [],
        requiredContextRole: [],
        requiredOwnedElements: [],
        requiredProps: {},
...
var Ag = {
        ...
        prohibitedProps: [],
        props: {},
        relatedConcepts: [{ concept: { constraints: ['direct descendant of document'], name: 'footer' }, module: 'HTML' }],
        requireContextRole: [],
        requiredContextRole: [],
        requiredOwnedElements: [],
        requiredProps: {},
...
var Zg = {
        ...
        relatedConcepts: [{ concept: { attributes: [{ name: 'role', value: 'grid' }], name: 'table' }, module: 'HTML' }],
        requireContextRole: [],
        requiredContextRole: [],
...
var tE = {
        ...
        relatedConcepts: [{ concept: { attributes: [{ name: 'role', value: 'gridcell' }], name: 'td' }, module: 'HTML' }],
        requireContextRole: ['row'],
        requiredContextRole: ['row'],
        requiredOwnedElements: [],
        requiredProps: {},
        ...
        for (n.s(); !(a = n.n()).done; ) {
            ...
            try {
                var i = function () {
                    ...
                    if (f)
                        for (var p = f[1], m = 0, C = Object.keys(p.props); m < C.length; m++) {
                            var R = C[m]
                            Object.prototype.hasOwnProperty.call(r.props, R) || Object.assign(r.props, uO({}, R, p.props[R]))
                        }
                }
    ...
    if (!Object.keys) {
        var t = Object.prototype.hasOwnProperty,
            ...
            d = (function () {
                ...
                for (var p in window)
                    try {
                        if (!s['$' + p] && t.call(window, p) && window[p] !== null && typeof window[p] == 'object')
                            try {
                                i(window[p])
                            } catch {
                                return !0
        ...
        e = function (m) {
            ...
            var P = l && R
            if (v && m.length > 0 && !t.call(m, 0)) for (var w = 0; w < m.length; ++w) b.push(String(w))
            if (S && m.length > 0) for (var O = 0; O < m.length; ++O) b.push(String(O))
            else for (var y in m) !(P && y === 'prototype') && t.call(m, y) && b.push(String(y))
            if (o) for (var h = f(m), E = 0; E < u.length; ++E) !(h && u[E] === 'constructor') && t.call(m, u[E]) && b.push(u[E])
            return b
        }
    }
    return (Pl = e), Pl
...
var ou = Ar,
    ...
    bO = Object,
    hO = function () {
        return { __proto__: Cs }.foo === Cs.foo && !({ __proto__: null } instanceof bO)
    },
    ...
    RO = function (t) {
        var r = this
        if (typeof r != 'function' || EO.call(r) !== _O) throw new TypeError(gO + r)
        for (
...
var Ol = function () {
    ...
    Ye = {
        ...
        '%MapIteratorPrototype%': typeof Map > 'u' || !dt || !k ? T : k(new Map()[Symbol.iterator]()),
        '%Math%': Math,
        '%Number%': Number,
        '%Object%': Object,
        ...
        '%SetIteratorPrototype%': typeof Set > 'u' || !dt || !k ? T : k(new Set()[Symbol.iterator]()),
...
var TO = function e(t) {
    ...
    IO = function (t) {
        var r = Hr(t, 0, 1),
            n = Hr(t, -1)
        if (r === '%' && n !== '%') throw new Et('invalid intrinsic syntax, expected closing `%`')
        if (n === '%' && r !== '%') throw new Et('invalid intrinsic syntax, expected opening `%`')
        var a = []
        return (
    ...
    ve = function (t, r) {
        if (typeof t != 'string' || t.length === 0) throw new mt('intrinsic name must be a non-empty string')
        if (arguments.length > 1 && typeof r != 'boolean') throw new mt('"allowMissing" argument must be a boolean')
        if (xO(/^%?[^%]*%?$/, t) === null)
        ...
        for (var d = 1, f = !0; d < n.length; d += 1) {
            ...
            if (((p === 'constructor' || !f) && (i = !0), (a += '.' + p), (l = '%' + a + '%'), Vr(Ye, l))) u = Ye[l]
            else if (u != null) {
                if (!(p in u)) {
                    if (!r) throw new mt('base intrinsic for ' + t + ' exists, but the property is not available.')
                    return
                }
                if (Ge && d + 1 >= n.length) {
                    var R = Ge(u, p)
                    ;(f = !!R), f && 'get' in R && !('originalValue' in R.get) ? (u = R.get) : (u = u[p])
                } else (f = Vr(u, p)), (u = u[p])
                f && !i && (Ye[l] = u)
            }
        }
...
var DO = fi,
    ...
    WO = function (e, t, r, n) {
        ...
        Tf ? $f(e, t, { configurable: !0, enumerable: !1, value: r, writable: !0 }) : (e[t] = r)
    },
    qf = function (e, t) {
...
;(function (e) {
    ...
    e.exports = function (f) {
        ...
        if (l && u) {
            var m = l(p, 'length')
            m.configurable && u(p, 'length', { value: 1 + i(0, f.length - (arguments.length - 1)) })
        }
        return p
    }
    var s = function () {
...
;(function (e) {
    var t = u0.functionsHaveConfigurableNames(),
        ...
        n = TypeError
    ;(e.exports = function () {
        if (this != null && this !== r(this)) throw new n('RegExp.prototype.flags getter called on non-object')
        var o = ''
        return (
            this.hasIndices && (o += 'd'),
            this.global && (o += 'g'),
...
var Ff = Lf.exports,
    ...
    b0 = /a/,
    h0 = function () {
        if (!f0 || !qs) throw new m0('RegExp.prototype.flags requires a true ES5 environment that supports property descriptors')
        var t = p0(),
            r = qs(b0),
            n = v0(r, 'flags')
        return (!n || n.get !== t) && y0(r, 'flags', { configurable: !0, enumerable: !1, get: t }), t
    },
    g0 = tt,
    E0 = ur,
    _0 = Ff,
...
var P0 = Hf,
    ...
    Yo = function (t) {
        return C0 && t && typeof t == 'object' && Symbol.toStringTag in t ? !1 : pi(t) === '[object Arguments]'
    },
    Wf = function (t) {
        return Yo(t)
            ? !0
...
var zf = S0 ? Yo : Wf
const $0 = {},
    T0 = Object.freeze(Object.defineProperty({ __proto__: null, default: $0 }, Symbol.toStringTag, { value: 'Module' })),
    q0 = Ed(T0)
var uu = typeof Map == 'function' && Map.prototype,
    $l = Object.getOwnPropertyDescriptor && uu ? Object.getOwnPropertyDescriptor(Map.prototype, 'size') : null,
    Wr = uu && $l && typeof $l.get == 'function' ? $l.get : null,
    As = uu && Map.prototype.forEach,
    su = typeof Set == 'function' && Set.prototype,
    Tl = Object.getOwnPropertyDescriptor && su ? Object.getOwnPropertyDescriptor(Set.prototype, 'size') : null,
    ...
    W =
        typeof Symbol == 'function' && Symbol.toStringTag && (typeof Symbol.toStringTag === _t || 'symbol')
            ? Symbol.toStringTag
            : null,
    ...
    Ns =
        ...
        ([].__proto__ === Array.prototype
            ...
            : null)
function Ds(e, t) {
    if (e === 1 / 0 || e === -1 / 0 || e !== e || (e && e > -1e3 && e < 1e3) || Kf.call(/e/, t)) return t
...
var mi = q0,
    ...
    L0 = function e(t, r, n, a) {
        ...
        if ((typeof n > 'u' && (n = 0), n >= d && d > 0 && typeof t == 'object')) return bi(t) ? '[Array]' : '[Object]'
        var f = aS(o, n)
        if (typeof a > 'u') a = []
        ...
        function p(K, ce, it) {
            if ((ce && ((a = k0.call(a)), a.push(ce)), it)) {
                ...
                return qe(o, 'quoteStyle') && (xt.quoteStyle = o.quoteStyle), e(K, xt, n + 1, a)
            }
            return e(K, o, n + 1, a)
        }
        if (typeof t == 'function' && !Fs(t)) {
            var m = Y0(t),
                C = _r(t, p)
            return '[Function' + (m ? ': ' + m : ' (anonymous)') + ']' + (C.length > 0 ? ' { ' + fe.call(C, ', ') + ' }' : '')
        }
        if (Jf(t)) {
            var R = _t ? Me.call(String(t), /^(Symbol\(.*\))_[^)]*$/, '$1') : yi.call(t)
            return typeof t == 'object' && !_t ? Bt(R) : R
        }
        if (tS(t)) {
            for (var S = '<' + Bs.call(String(t.nodeName)), v = t.attributes || [], b = 0; b < v.length; b++)
        ...
        if (bi(t)) {
            ...
            var P = _r(t, p)
            return f && !nS(P) ? '[' + hi(P, f) + ']' : '[ ' + fe.call(P, ', ') + ' ]'
        }
        if (V0(t)) {
            var w = _r(t, p)
            return !('cause' in Error.prototype) && 'cause' in t && !Gf.call(t, 'cause')
                ? '{ [' + String(t) + '] ' + fe.call(Is.call('[cause]: ' + p(t.cause), w), ', ') + ' }'
                : w.length === 0
                ? '[' + String(t) + ']'
                : '{ [' + String(t) + '] ' + fe.call(w, ', ') + ' }'
        }
        if (typeof t == 'object' && l) {
            if (Ls && typeof t[Ls] == 'function' && mi) return mi(t, { depth: d - n })
        ...
        if (!U0(t) && !Fs(t)) {
            var h = _r(t, p),
                E = Ns ? Ns(t) === Object.prototype : t instanceof Object || t.constructor === Object,
                I = t instanceof Object ? '' : 'null prototype',
                c = !E && W && Object(t) === t && W in t ? cu.call(He(t), 8, -1) : I ? 'Object' : '',
                z = E || typeof t.constructor != 'function' ? '' : t.constructor.name ? t.constructor.name + ' ' : '',
                se = z + (c || I ? '[' + fe.call(Is.call([], c || [], I || []), ': ') + '] ' : '')
            return h.length === 0 ? se + '{}' : f ? se + '{' + hi(h, f) + '}' : se + '{ ' + fe.call(h, ', ') + ' }'
        }
        return String(t)
    }
function Yf(e, t, r) {
...
function bi(e) {
    return He(e) === '[object Array]' && (!W || !(typeof e == 'object' && W in e))
}
function U0(e) {
    return He(e) === '[object Date]' && (!W || !(typeof e == 'object' && W in e))
}
function Fs(e) {
    return He(e) === '[object RegExp]' && (!W || !(typeof e == 'object' && W in e))
}
function V0(e) {
    return He(e) === '[object Error]' && (!W || !(typeof e == 'object' && W in e))
}
function H0(e) {
    return He(e) === '[object String]' && (!W || !(typeof e == 'object' && W in e))
}
function W0(e) {
    return He(e) === '[object Number]' && (!W || !(typeof e == 'object' && W in e))
}
function z0(e) {
    return He(e) === '[object Boolean]' && (!W || !(typeof e == 'object' && W in e))
}
function Jf(e) {
...
function aS(e, t) {
    var r
    if (e.indent === '	') r = '	'
    else if (typeof e.indent == 'number' && e.indent > 0) r = fe.call(Array(e.indent + 1), ' ')
    else return null
    ...
    for (var i in e)
        qe(e, i) &&
            ((r && String(Number(i)) === i && i < e.length) ||
                ...
                (Kf.call(/[^\w$]/, i) ? n.push(t(i, e) + ': ' + t(e[i], e)) : n.push(i + ': ' + t(e[i], e))))
    if (typeof ql == 'function')
        for (var s = 0; s < o.length; s++) Gf.call(e, o[s]) && n.push('[' + t(o[s]) + ']: ' + t(e[o[s]], e))
    return n
}
var du = ve,
    St = Z,
    ...
    pu = {
        assert: function (e, t) {
            if (!e || (typeof e != 'object' && typeof e != 'function')) throw new me('`O` is not an object')
            if (typeof t != 'string') throw new me('`slot` must be a string')
            if ((It.assert(e), !pu.has(e, t))) throw new me('`' + t + '` is not present on `O`')
        },
        get: function (e, t) {
            if (!e || (typeof e != 'object' && typeof e != 'function')) throw new me('`O` is not an object')
            if (typeof t != 'string') throw new me('`slot` must be a string')
...
var hS = pu,
    ...
    OS = Ve(),
    tp = function (t) {
        return typeof t == 'string' ? !0 : typeof t != 'object' ? !1 : OS ? PS(t) : wS.call(t) === CS
    },
...
if (lu() || Go()) {
    ...
    if (!AS && !xS)
        ...
        var rc = ne('Map.prototype.@@iterator', !0) || ne('Map.prototype._es6-shim iterator_', !0),
            nc = ne('Set.prototype.@@iterator', !0) || ne('Set.prototype._es6-shim iterator_', !0),
            NS = function (t) {
                if (IS(t)) {
...
var DS = xr.exports,
    ...
    lp = function (t, r) {
        return t === 0 && r === 0 ? 1 / t === 1 / r : !!(t === r || (ac(t) && ac(r)))
    },
    kS = lp,
    ip = function () {
    ...
    Br.call(n$) === Br.call(document.all) &&
        (_i = function (t) {
            if ((r$ || !t) && (typeof t > 'u' || typeof t == 'object'))
                try {
                    var r = Br.call(t)
                    return (r === QS || r === ZS || r === e$ || r === YS) && t('') == null
                } catch {}
            return !1
        })
}
var a$ = yt
    ...
    i$ = function (t, r, n) {
        for (var a = 0, o = t.length; a < o; a++) dp.call(t, a) && (n == null ? r(t[a], a, t) : r.call(n, t[a], a, t))
    },
    u$ = function (t, r, n) {
        for (var a = 0, o = t.length; a < o; a++) n == null ? r(t.charAt(a), a, t) : r.call(n, t.charAt(a), a, t)
    },
    s$ = function (t, r, n) {
        for (var a in t) dp.call(t, a) && (n == null ? r(t[a], a, t) : r.call(n, t[a], a, t))
    },
    c$ = function (t, r, n) {
        if (!o$(r)) throw new TypeError('iterator must be a function')
        var a
        arguments.length >= 3 && (a = n),
            l$.call(t) === '[object Array]' ? i$(t, r, a) : typeof t == 'string' ? u$(t, r, a) : s$(t, r, a)
    },
    fp = c$,
    Il = [
        'BigInt64Array',
    ...
    pp = function () {
        for (var t = [], r = 0; r < Il.length; r++) typeof d$[Il[r]] == 'function' && (t[t.length] = Il[r])
        return t
    },
    f$ = ve,
...
var h$ = function (t) {
    ...
    O$ = Ve(),
    S$ = function (t) {
        return typeof t != 'object' || t === null ? !1 : O$ ? P$(t) : w$.call(t) === C$
    },
    Ri = Z,
    Rp = Ve(),
    Pp,
    ...
    wi
if (Rp) {
    ;(Pp = Ri('Object.prototype.hasOwnProperty')), (wp = Ri('RegExp.prototype.exec')), (Pi = {})
    var Nl = function () {
        throw Pi
    }
    ;(wi = { toString: Nl, valueOf: Nl }), typeof Symbol.toPrimitive == 'symbol' && (wi[Symbol.toPrimitive] = Nl)
}
var $$ = Ri('Object.prototype.toString'),
    ...
    A$ = Rp
        ...
        : function (t) {
              return !t || (typeof t != 'object' && typeof t != 'function') ? !1 : $$(t) === q$
          },
    x$ = Z,
    ...
    D$ = Ve(),
    k$ = function (t) {
        return typeof t == 'number' ? !0 : typeof t != 'object' ? !1 : D$ ? I$(t) : j$.call(t) === N$
    },
    Cp = Z,
...
var X$ = Ci.exports,
    ...
    Q$ = function () {
        return (
            typeof cc == 'function' && typeof BigInt == 'function' && typeof cc(42) == 'bigint' && typeof BigInt(42) == 'bigint'
        )
    },
    Z$ = Q$()
if (Z$) {
...
var RT = function (t) {
    ...
    PT = gp,
    wT = function (t) {
        return PT(t) ? (!Tp || !(Symbol.toStringTag in t) ? _T(gT(t), 8, -1) : RT(t)) : !1
    },
    CT = Z,
...
function Ac(e, t, r, n) {
    for (var a = Rt(e), o; (o = a.next()) && !o.done; ) if (ie(t, o.value, r, n)) return xp(e, o.value), !0
    return !1
}
function Mp(e) {
...
function qT(e, t, r, n, a, o) {
    ...
    var u = Qr(t, l),
        i = Ap({}, a, { strict: !1 })
    return (typeof u > 'u' && !Ti(t, l)) || !ie(n, u, i, o) ? !1 : !Ti(e, l) && ie(n, u, i, o)
}
function AT(e, t, r) {
    var n = Mp(r)
...
function xc(e, t, r, n, a, o) {
    for (var l = Rt(e), u, i; (u = l.next()) && !u.done; )
        if (((i = u.value), ie(r, i, a, o) && ie(n, Qr(t, i), a, o))) return xp(e, i), !0
    return !1
}
function ie(e, t, r, n) {
    var a = r || {}
    ...
    var o = Pc(e),
        l = Pc(t)
    if (o !== l) return !1
    if (!e || !t || (typeof e != 'object' && typeof t != 'object')) return a.strict ? yc(e, t) : e == t
    var u = n.has(e),
        i = n.has(t),
        s
    if (u && i) {
...
function xT(e, t, r, n) {
    ...
    for (var a = Rt(e), o = Rt(t), l, u, i; (l = a.next()) && !l.done; )
        if (l.value && typeof l.value == 'object') i || (i = new Xr()), Zr(i, l.value)
    ...
    if (i) {
        for (; (u = o.next()) && !u.done; )
            ...
            } else if (!r.strict && !en(e, u.value) && !Ac(i, u.value, r.strict, n)) return !1
        return Dr(i) === 0
    }
    return !0
}
function MT(e, t, r, n) {
    ...
    for (var a = Rt(e), o = Rt(t), l, u, i, s, d, f; (l = a.next()) && !l.done; )
        if (((s = l.value[0]), (d = l.value[1]), s && typeof s == 'object')) i || (i = new Xr()), Zr(i, s)
        else if (((f = Qr(t, s)), (typeof f > 'u' && !Ti(t, s)) || !ie(d, f, r, n))) {
    ...
    if (i) {
        for (; (u = o.next()) && !u.done; )
            ...
            } else if (!r.strict && (!e.has(s) || !ie(Qr(e, s), f, r, n)) && !xc(i, e, s, f, Ap({}, r, { strict: !1 }), n))
                return !1
        return Dr(i) === 0
    }
    return !0
...
function BT(e, t, r, n) {
    var a, o
    if (typeof e != typeof t || e == null || t == null || Tc(e) !== Tc(t) || mc(e) !== mc(t)) return !1
    var l = bc(e),
        u = bc(t)
    if (l !== u) return !1
    var i = e instanceof Error,
        s = t instanceof Error
    if (i !== s || ((i || s) && (e.name !== t.name || e.message !== t.message))) return !1
    var d = Ec(e),
        f = Ec(t)
    if (d !== f || ((d || f) && (e.source !== t.source || vc(e) !== vc(t)))) return !1
    var p = gc(e),
        m = gc(t)
    if (p !== m || ((p || m) && $c(e) !== $c(t)) || (r.strict && Vl && Vl(e) !== Vl(t))) return !1
    var C = Cc(e),
        R = Cc(t)
    if ((C || R) && C !== R) return !1
    var S = Mc(e),
    ...
    var b = hc(e),
        P = hc(t)
    if (b !== P) return !1
    if (b || P) return Oc(e) !== Oc(t) ? !1 : typeof Uint8Array == 'function' && ie(new Uint8Array(e), new Uint8Array(t), r, n)
    var w = _c(e),
        O = _c(t)
    if (w !== O) return !1
    if (w || O) return Sc(e) !== Sc(t) ? !1 : typeof Uint8Array == 'function' && ie(new Uint8Array(e), new Uint8Array(t), r, n)
    if (typeof e != typeof t) return !1
    var y = Rc(e),
        h = Rc(t)
    if (y.length !== h.length) return !1
    for (y.sort(), h.sort(), a = y.length - 1; a >= 0; a--) if (y[a] != h[a]) return !1
    for (a = y.length - 1; a >= 0; a--) if (((o = y[a]), !ie(e[o], t[o], r, n))) return !1
    var E = wc(e),
        I = wc(t)
    return E !== I ? !1 : E === 'Set' || I === 'Set' ? xT(e, t, r, n) : E === 'Map' ? MT(e, t, r, n) : !0
}
...
function FT(e, t) {
    var r = (typeof Symbol < 'u' && e[Symbol.iterator]) || e['@@iterator']
    if (!r) {
        if (Array.isArray(e) || (r = Ip(e)) || (t && e && typeof e.length == 'number')) {
            r && (e = r)
            var n = 0,
                a = function () {}
            return {
...
for (var Wl = 0; Wl < Ic.length; Wl++) {
    ...
    if (Kl)
        for (var jc = [].concat(Kl.baseConcepts, Kl.relatedConcepts), Gl = 0; Gl < jc.length; Gl++) {
            var Nc = jc[Gl]
            if (Nc.module === 'HTML') {
                var Yl = Nc.concept
                Yl &&
...
function KT(e, t) {
    var r = (typeof Symbol < 'u' && e[Symbol.iterator]) || e['@@iterator']
    if (!r) {
        if (Array.isArray(e) || (r = Dp(e)) || (t && e && typeof e.length == 'number')) {
            r && (e = r)
            var n = 0,
                a = function () {}
            return {
...
Jo.default = YT
Object.defineProperty(le, '__esModule', { value: !0 })
var vt = (le.roles = Fp = le.roleElements = Lp = le.elementRoles = le.dom = le.aria = void 0),
    JT = sr(dn),
    XT = sr(pn),
    QT = sr(Ot),
    ZT = sr(Ko),
    ...
    var t = (function () {
        ...
        var u = {
            ...
            compressToUint8Array: function (i) {
                for (var s = u.compress(i), d = new Uint8Array(s.length * 2), f = 0, p = s.length; f < p; f++) {
            ...
            decompressFromUint8Array: function (i) {
                ...
                for (var s = new Array(i.length / 2), d = 0, f = s.length; d < f; d++) s[d] = i[d * 2] * 256 + i[d * 2 + 1]
                var p = []
                return (
            ...
            _compress: function (i, s, d) {
                ...
                for (E = 0; E < i.length; E += 1)
                    if (
                        ((R = i.charAt(E)),
                        Object.prototype.hasOwnProperty.call(m, R) || ((m[R] = P++), (C[R] = !0)),
                        (S = v + R),
                        ...
                        if (Object.prototype.hasOwnProperty.call(C, v)) {
                            if (v.charCodeAt(0) < 256) {
                                for (f = 0; f < w; f++) (y = y << 1), h == s - 1 ? ((h = 0), O.push(d(y)), (y = 0)) : h++
                                for (p = v.charCodeAt(0), f = 0; f < 8; f++)
                                    (y = (y << 1) | (p & 1)), h == s - 1 ? ((h = 0), O.push(d(y)), (y = 0)) : h++, (p = p >> 1)
                            } else {
                                for (p = 1, f = 0; f < w; f++)
                                    (y = (y << 1) | p), h == s - 1 ? ((h = 0), O.push(d(y)), (y = 0)) : h++, (p = 0)
                            ...
                            for (p = m[v], f = 0; f < w; f++)
                                (y = (y << 1) | (p & 1)), h == s - 1 ? ((h = 0), O.push(d(y)), (y = 0)) : h++, (p = p >> 1)
                        b--, b == 0 && ((b = Math.pow(2, w)), w++), (m[S] = P++), (v = String(R))
                    }
                if (v !== '') {
                    if (Object.prototype.hasOwnProperty.call(C, v)) {
                        if (v.charCodeAt(0) < 256) {
            ...
            _decompress: function (i, s, d) {
                ...
                for (f[3] = h, b = h, S.push(h); ; ) {
                    ...
                    S.push(R), (f[m++] = b + R.charAt(0)), p--, (b = R), p == 0 && ((p = Math.pow(2, C)), C++)
                }
            },
        }
        return u
...
`) !== -1 && (f = r.spacingOuter + u + f + r.spacingOuter + n),
    ...
    cq = (e, t, r, n, a, o) =>
        e
            .map((l) => {
                ...
                return u === '' && typeof l == 'object' && l !== null && l.nodeType !== sq ? '' : t.spacingOuter + r + u
            })
            .join(''),
    Vp = (e, t) => {
        const r = t.colors.content
    ...
    mq = (e) => {
        const t = e.constructor.name,
            { nodeType: r, tagName: n } = e,
            a = (typeof n == 'string' && n.includes('-')) || (typeof e.hasAttribute == 'function' && e.hasAttribute('is'))
        return (
            (r === vq && (yq.test(t) || a)) ||
            (r === Hp && t === 'Text') ||
            (r === Wp && t === 'Comment') ||
...
function gq(e) {
    return {
        test: (t) => {
            var r
            return (t == null || (r = t.constructor) == null ? void 0 : r.name) && mq(t)
        },
        serialize: (t, r, n, a, o, l) => {
            ...
            return ++a > r.maxDepth
                ...
                : fq(
                      ...
                      uq(
                          Ql(t)
                              ...
                              : Array.from(t.attributes)
                                    .map((i) => i.name)
                                    .sort(),
                          Ql(t) ? {} : Array.from(t.attributes).reduce((i, s) => ((i[s.name] = s.value), i), {}),
                          r,
                          n + r.indent,
                          a,
                          o,
                      ...
                      cq(Array.prototype.slice.call(t.childNodes || t.children).filter(e), r, n + r.indent, a, o, l),
                      r,
                      n,
                  )
        },
...
function Eq(e) {
    ...
    const s = Eu(i, { start: { line: l, column: u } }, { highlightCode: !0, linesBelow: 0 })
    return (
        Kp.dim(n) +
        `
` +
...
const Rq = () => {
    ...
    Cq = 8
function Oq(e) {
    return e.nodeType !== Cq && (e.nodeType !== wq || !e.matches(q().defaultIgnore))
}
function Gt(e, t, r) {
    if (
        (r === void 0 && (r = {}),
    ...
    const { filterNode: a = Oq, ...o } = r,
        l = ef(e, { plugins: [gq(a), Pq], printFunctionName: !1, highlight: Rq(), ...o })
...
const Tq = ['button', 'meter', 'output', 'progress', 'select', 'textarea', 'input']
function Jp(e) {
...
function Mi(e) {
    let t
    return e.tagName.toLowerCase() === 'label' ? (t = Jp(e)) : (t = e.value || e.textContent), t
}
function Xp(e) {
    if (e.labels !== void 0) {
        var t
...
function Qp(e, t, r) {
    ...
    return o.length
        ? o.map((l) => {
              ...
              return u ? { content: Mi(u), formControl: null } : { content: '', formControl: null }
          })
...
function ge(e, t, r, n) {
    ...
    Zp(r)
    const a = n(e)
    return r instanceof Function ? r(a, t) : r instanceof RegExp ? ev(r, a) : a === String(r)
}
function Ru(e) {
...
function xq(e) {
        ...
        return (
            ...
            i
                .map((s) => {
                    ...
                    return p.indexOf('undefined') !== -1 ? ':not([' + d + '])' : f ? '[' + d + '="' + f + '"]' : '[' + d + ']'
                })
                .join('')
        )
    }
    ...
    function a(l) {
        let { attributes: u = [] } = l
        const i = u.findIndex((d) => d.value && d.name === 'type' && d.value === 'text')
        i >= 0 && (u = [...u.slice(0, i), ...u.slice(i + 1)])
        const s = t({ ...l, attributes: u })
        return (d) => (i >= 0 && d.type !== 'text' ? !1 : d.matches(s))
    }
    let o = []
    for (const [l, u] of e.entries()) o = [...o, { match: a(l), roles: Array.from(u), specificity: r(l) }]
    return o.sort(n)
}
function rv(e, t) {
    ...
    return n(e)
        ...
        .reduce((a, o) => {
            let l = []
            return (
                o.hasAttribute('role') ? (l = o.getAttribute('role').split(' ').slice(0, 1)) : (l = Pu(o)),
                l.reduce((u, i) => (Array.isArray(u[i]) ? { ...u, [i]: [...u[i], o] } : { ...u, [i]: [o] }), a)
            )
        }, {})
}
function nv(e, t) {
        ...
        .map((o) => {
            ...
            const i = '-'.repeat(50),
                s = u.map((d) => {
                    const f =
                            'Name "' +
                            nu(d, { computedStyleSupportsPseudoElements: q().computedStyleSupportsPseudoElements }) +
                            `":
`,
                        p = Gt(d.cloneNode(!1))
                    if (n) {
                        const m =
                            'Description "' +
                            _f(d, { computedStyleSupportsPseudoElements: q().computedStyleSupportsPseudoElements }) +
                            `":
`
                        return '' + f + m + p
                    }
...
function Iq(e) {
    if (!('indeterminate' in e && e.indeterminate)) return 'checked' in e ? e.checked : dr(e, 'aria-checked')
}
function jq(e) {
...
function Nq(e) {
    var t, r
    return (t = (r = dr(e, 'aria-current')) != null ? r : e.getAttribute('aria-current')) != null ? t : !1
}
function Dq(e) {
...
function tn(e, t, r) {
    ...
    const o = (n = e.getAttribute('role')) != null ? n : (a = Pu(e)) == null ? void 0 : a[0]
    if (o !== 'generic' && Se('Role', r, o))
        return Oe('Role', e, o, {
            variant: t,
            name: nu(e, { computedStyleSupportsPseudoElements: q().computedStyleSupportsPseudoElements }),
        })
    ...
    if (Se('PlaceholderText', r, u)) return Oe('PlaceholderText', e, u, { variant: t })
    const i = kc(cr(e))
    if (Se('Text', r, i)) return Oe('Text', e, i, { variant: t })
    if (Se('DisplayValue', r, e.value)) return Oe('DisplayValue', e, kc(e.value), { variant: t })
...
function Fq(e, t) {
    let {
        ...
        stackTraceError: o,
        interval: l = 50,
        onTimeout: u = (s) => ((s.message = q().getElementError(s.message, r).message), s),
        mutationObserverOptions: i = { subtree: !0, childList: !0, attributes: !0, characterData: !0 },
    } = t
    ...
    return new Promise(async (s, d) => {
        ...
        function b(y, h) {
            ;(C = !0), clearTimeout(S), v || (clearInterval(p), m.disconnect()), y ? d(y) : s(h)
        }
        function P() {
            if (Zl()) {
                const y = new Error(
...
function nt(e, t, r, n) {
    let { exact: a = !0, collapseWhitespace: o, trim: l, normalizer: u } = n === void 0 ? {} : n
    const i = a ? ge : rt,
        s = We({ collapseWhitespace: o, trim: l, normalizer: u })
    return Array.from(t.querySelectorAll('[' + e + ']')).filter((d) => i(d.getAttribute(e), d, r, s))
}
function av(e, t, r, n) {
    const a = nt(e, t, r, n)
    if (a.length > 1) throw Zo('Found multiple elements by [' + e + '=' + r + ']', t)
    return a[0] || null
}
function Pt(e, t) {
    return function (r) {
    ...
    X = (e, t, r) =>
        function (n) {
            ...
            if (u.length && i) {
                ...
                if (s.length === 1 && !t.endsWith(tn(u[0], r).queryName)) throw ov(s[0], n)
            }
            return u
        }
function Pe(e, t, r) {
...
const Hq = function (e, t, r) {
    ...
    Yt = function (e, t, r) {
        let { selector: n = '*', exact: a = !0, collapseWhitespace: o, trim: l, normalizer: u } = r === void 0 ? {} : r
        Re(e)
        const i = a ? ge : rt,
            s = We({ collapseWhitespace: o, trim: l, normalizer: u }),
            d = Array.from(e.querySelectorAll('*'))
                ...
                .reduce((f, p) => {
                    ...
                    m.filter((R) => !!R.formControl).forEach((R) => {
                        i(R.content, R.formControl, t, s) && R.formControl && f.push(R.formControl)
                    })
                    ...
                    return (
                        ...
                        C.length > 1 &&
                            C.forEach((R, S) => {
                                i(R, p, t, s) && f.push(p)
                                const v = [...C]
                                v.splice(S, 1), v.length > 1 && i(v.join(' '), p, t, s) && f.push(p)
                            }),
                        f
                    )
                }, [])
...
`),
            ...
            } else throw q().getElementError('Unable to find a label with the text of: ' + t, e)
        }
        return o
    }
function Wq(e, t) {
...
const lv = (e, t) => 'Found multiple elements with the text of: ' + t,
    ...
    Ii = function (e, t, r) {
        ...
        return (
            ...
            [...f, ...Array.from(e.querySelectorAll(n))].filter((p) => !u || !p.matches(u)).filter((p) => s(cr(p), p, t, d))
        )
    },
    ...
    Qq = /^(img|input|area|.+-.+)$/i,
    Ni = function (e, t, r) {
        return r === void 0 && (r = {}), Re(e), nt('alt', e, t, r).filter((n) => Qq.test(n.tagName))
    },
...
function ki(e, t, r) {
    ...
    if (f !== void 0) {
        var P
        if (((P = vt.get(t)) == null ? void 0 : P.props['aria-selected']) === void 0)
    ...
    if (R !== void 0 && t !== 'heading') throw new Error('Role "' + t + '" cannot have "level" property.')
    if (S !== void 0) {
        var h
        if (((h = vt.get(t)) == null ? void 0 : h.props['aria-expanded']) === void 0)
    ...
    return Array.from(e.querySelectorAll(aA(t, n, s ? b : void 0)))
        ...
        .filter((c) =>
            l === void 0
                ? !0
                : ge(nu(c, { computedStyleSupportsPseudoElements: q().computedStyleSupportsPseudoElements }), c, l, (z) => z),
        )
        .filter((c) =>
            u === void 0
                ? !0
                : ge(_f(c, { computedStyleSupportsPseudoElements: q().computedStyleSupportsPseudoElements }), c, u, (z) => z),
        )
        .filter((c) => (o === !1 ? Xo(c, { isSubtreeInaccessible: I }) === !1 : !0))
}
function aA(e, t, r) {
    var n
...
const Hv = (e) => {
    ...
    lA = function (e, t, r) {
        let { hidden: n = q().defaultHidden, name: a, description: o } = r === void 0 ? {} : r
        if (q()._disableExpensiveErrorDiagnostics) return 'Unable to find role="' + t + '"' + Hv(a)
        let l = ''
...
`
        ...
        let i = ''
        a === void 0 ? (i = '') : typeof a == 'string' ? (i = ' and name "' + a + '"') : (i = ' and name `' + a + '`')
        let s = ''
        return (
            o === void 0
                ? (s = '')
...
function kr(e, t, r, n) {
    ...
    u !== void 0 && cA(t, u),
        i !== void 0 && Object.defineProperty(t, 'files', { configurable: !0, enumerable: !0, writable: !0, value: i }),
        Object.assign(t, s)
    const d = Yp(t),
        f = d[a] || d.Event
    let p
...
Object.keys(Uc).forEach((e) => {
    const { EventType: t, defaultInit: r } = Uc[e],
        n = e.toLowerCase()
    ;(kr[e] = (a, o) => kr(n, a, o, { EventType: t, defaultInit: r })), (Jt[e] = (a, o) => Jt(a, kr[e](a, o)))
})
function cA(e, t) {
...
const vA = (e, t, r) => (Array.isArray(e) ? e.forEach((n) => xi(n, t, r)) : xi(e, t, r)),
    yA = function (e) {
...
function Gc(e, t) {
    ...
    const [n, a] = t === 'button' ? [Kc, zc] : [zc, Kc],
        o = (r = Object.entries(n).find(([, l]) => l === e)) == null ? void 0 : r[0]
...
var Jc = we
const gA = ['button', 'color', 'file', 'image', 'reset', 'submit', 'checkbox', 'radio']
function EA(e) {
    return (0, Jc.isElementType)(e, 'button') || ((0, Jc.isElementType)(e, 'input') && gA.includes(e.type))
}
var Tu = {}
...
function Au(e) {
    return (0, bt.isElementType)(e, 'textarea') || ((0, bt.isElementType)(e, 'input') && !!Ui[e.type])
}
function iy(e) {
    if (Au(e)) return { selectionStart: e.selectionStart, selectionEnd: e.selectionEnd }
    if ((0, bt.isElementType)(e, 'input')) {
        var t
        return (t = e[ly]) != null ? t : { selectionStart: null, selectionEnd: null }
    }
...
function RA(e, t, r) {
    ...
    if (
        ...
        (0, bt.isElementType)(e, 'input') && (e[ly] = { selectionStart: t, selectionEnd: r }),
        (0, bt.isElementType)(e, 'input') || (0, bt.isElementType)(e, 'textarea'))
    )
        return
    const o = e.ownerDocument.createRange()
    o.selectNodeContents(e), e.firstChild && (o.setStart(e.firstChild, t), o.setEnd(e.firstChild, r))
...
function AA(
    ...
    return (
        ...
        t.type === 'time' && !(0, Qc.isValidInputTimeValue)(t, f) && ((0, Qc.isValidInputTimeValue)(t, e) ? (f = e) : (f = r)),
...
function MA(e) {
    ...
    return r === n && (r ?? 0) === ((t = (0, xA.getValue)(e)) != null ? t : '').length
}
function BA(e) {
...
var sy = we,
    NA = fr
function DA(e) {
    return cy(e) || (0, sy.isElementType)(e, 'textarea', { readOnly: !1 }) || (0, NA.isContentEditable)(e)
}
let nn
...
function UA(e) {
    return (0, Zc.isElementType)(e, 'textarea') || ((0, Zc.isElementType)(e, 'input') && !!Hi[e.type])
}
var Bu = {},
    pr = {}
...
var YA = nl,
    JA = vr
function XA(e) {
    return !(0, YA.isLabelWithInternallyDisabledControl)(e) && e.matches(JA.FOCUSABLE_SELECTOR)
}
var ju = {}
...
const d1 = (e) => !!(e && (e.querySelector('input[type="submit"]') || e.querySelector('button[type="submit"]')))
al.hasFormSubmit = d1
;(function (e) {
...
function f1(e, t, { skipPointerEventsCheck: r = !1 } = {}) {
    ...
    if (!(0, Y.isDisabled)(e)) {
        ...
        for (const a of n) te.fireEvent.mouseEnter(a, (0, Y.getMouseEventOptions)('mouseenter', t))
    }
    te.fireEvent.pointerMove(e, t), (0, Y.isDisabled)(e) || te.fireEvent.mouseMove(e, (0, Y.getMouseEventOptions)('mousemove', t))
}
function p1(e, t, { skipPointerEventsCheck: r = !1 } = {}) {
    ...
    te.fireEvent.pointerMove(e, t),
        (0, Y.isDisabled)(e) || te.fireEvent.mouseMove(e, (0, Y.getMouseEventOptions)('mousemove', t)),
    ...
    if (!(0, Y.isDisabled)(e)) {
        ...
        for (const a of n) te.fireEvent.mouseLeave(a, (0, Y.getMouseEventOptions)('mouseleave', t))
    }
}
var yr = {}
...
var ei = N
function v1(e) {
    !(0, ei.isFocusable)(e) || !((0, ei.getActiveElement)(e.ownerDocument) === e) || (0, ei.eventWrapper)(() => e.blur())
}
var qt = {}
...
var ti = N
function y1(e) {
    !(0, ti.isFocusable)(e) || (0, ti.getActiveElement)(e.ownerDocument) === e || (0, ti.eventWrapper)(() => e.focus())
}
...
function g1(e, t, { clickCount: r }) {
    G.fireEvent.pointerDown(e, t),
        e.disabled || G.fireEvent.mouseDown(e, (0, L.getMouseEventOptions)('mousedown', t, r)),
        (0, an.focus)(e),
        G.fireEvent.pointerUp(e, t),
        e.disabled ||
            (G.fireEvent.mouseUp(e, (0, L.getMouseEventOptions)('mouseup', t, r)),
...
function ed(e, t, { clickCount: r }) {
    ...
    if (
        (G.fireEvent.pointerDown(e, t),
        !(0, L.isDisabled)(e) && G.fireEvent.mouseDown(e, (0, L.getMouseEventOptions)('mousedown', t, r)))
    ) {
        const o = E1(e, L.isFocusable)
        n && !o ? (0, m1.blur)(n) : o && (0, an.focus)(o)
    }
    if ((G.fireEvent.pointerUp(e, t), !(0, L.isDisabled)(e))) {
        G.fireEvent.mouseUp(e, (0, L.getMouseEventOptions)('mouseup', t, r)), Fu(e, (0, L.getMouseEventOptions)('click', t, r))
...
function Wi(e, t, { skipHover: r = !1, clickCount: n = 0, skipPointerEventsCheck: a = !1 } = {}) {
...
function R1(e, t) {
    var r
    const { type: n, descriptor: a, consumedLength: o, releasePrevious: l, releaseSelf: u, repeat: i } = P1(e)
    return {
        keyDef:
            (r = t.keyboardMap.find((d) => {
                if (n === '[') {
                    var f
                    return ((f = d.code) == null ? void 0 : f.toLowerCase()) === a.toLowerCase()
                } else if (n === '{') {
                    var p
                    const m = S1(a)
                    return ((p = d.key) == null ? void 0 : p.toLowerCase()) === m.toLowerCase()
                }
                return d.key === a
            })) != null
                ? r
...
function w1(e, t) {
    const r = e[t]
    return vy(r, e, t), (t += r.length), { consumedLength: t, descriptor: r, releasePrevious: !1, releaseSelf: !0, repeat: 1 }
}
function C1(e, t, r) {
    var n, a, o
    const l = e[t] === '/' ? '/' : ''
    ...
    vy(u, e, t), (t += u.length)
    const i = (a = (o = e.slice(t).match(/^>\d+/)) == null ? void 0 : o[0]) != null ? a : ''
    t += i.length
    ...
    const d = on[r],
        f = e[t] === d ? d : ''
    if (!f)
        throw new Error(my([!i && 'repeat modifier', !s && 'release modifier', `"${d}"`].filter(Boolean).join(' or '), e[t], e))
    return (
        (t += f.length),
        {
            consumedLength: t,
...
const $1 = [
    {
        matches: (e, t) => (e.key === 'ArrowLeft' || e.key === 'ArrowRight') && (0, ri.isElementType)(t, ['input', 'textarea']),
        handle: (e, t) => {
            var r
            const { selectionStart: n, selectionEnd: a } = (0, ri.getSelectionRange)(t),
...
function T1(e, t, r) {
    ...
    t.carryValue = n !== r && n === '' && (0, td.hasUnreliableEmptyValue)(e) ? r : void 0
}
var zu = {}
...
var q1 = Q,
    A1 = N
function x1(e, t, r) {
    ;(0, A1.isValidInputTimeValue)(e, r) && t !== r && q1.fireEvent.change(e, { target: { value: r } })
}
var Ku = {}
Object.defineProperty(Ku, '__esModule', { value: !0 })
...
function rd(e, t, r) {
    ...
    if ((n && a && Object.defineProperty(e, t, a), e[Cr] === void 0 && (e[Cr] = String(e[t])), (e[t] = r), !e[ni])) {
        var o
        ;(o = e.ownerDocument.defaultView) == null ||
            o.addEventListener(
                ...
                (e[ni] = () => {
                    const l = e[Cr]
                    delete e[ni], delete e[Cr], String(e[t]) !== l && by.fireEvent.change(e)
                }),
                { capture: !0, once: !0 },
            )
    }
...
const j1 = [
    {
        matches: (e, t) =>
            ...
            ((0, ee.isElementType)(t, ['input', 'textarea']) || (0, ee.isContentEditable)(t)),
        handle: (e, t) => {
            if (e.key === 'Home') (0, ee.setSelectionRange)(t, 0, 0)
            else {
                var r, n
                const a = (r = (n = (0, ee.getValue)(t)) == null ? void 0 : n.length) != null ? r : 0
                ;(0, ee.setSelectionRange)(t, a, a)
            }
        },
    },
    {
        matches: (e, t) => (e.key === 'PageUp' || e.key === 'PageDown') && (0, ee.isElementType)(t, ['input']),
        handle: (e, t) => {
    ...
    {
        matches: (e, t) => e.key === 'Delete' && (0, ee.isEditable)(t) && !(0, ee.isCursorAtEnd)(t),
        handle: (e, t, r, n) => {
            const { newValue: a, newSelectionStart: o } = (0, ee.calculateNewValue)('', t, n.carryValue, void 0, 'forward')
...
const D1 = [
    {
        ...
        handle: (e, t, r, n) => {
            ...
            const { newValue: i, newSelectionStart: s } = (0, j.calculateNewValue)(o, t),
                d = (0, j.getValue)(t)
            d !== i &&
    ...
    },
    {
        ...
        handle: (e, t, r, n) => {
            ...
            const i = (a = (o = n.carryValue) != null ? o : (0, j.getValue)(t)) != null ? a : '',
                { newValue: s, newSelectionStart: d } = (0, j.calculateNewValue)(e.key, t, i),
                f = s.split('e', 2)
            if (
    ...
    },
    {
        matches: (e, t) => {
            ...
            return (
                ((r = e.key) == null ? void 0 : r.length) === 1 &&
                (((0, j.isElementType)(t, ['input', 'textarea'], { readOnly: !1 }) && !(0, j.isClickableInput)(t)) ||
                    (0, j.isContentEditable)(t)) &&
                (0, j.getSpaceUntilMaxLength)(t) !== 0
            )
        },
        handle: (e, t) => {
            const { newValue: r, newSelectionStart: n } = (0, j.calculateNewValue)(e.key, t)
            ;(0, ft.fireInputEvent)(t, {
                newValue: r,
                newSelectionStart: n,
                eventOverrides: { data: e.key, inputType: 'insertText' },
    ...
    },
    {
        matches: (e, t) =>
            e.key === 'Enter' &&
            ((0, j.isElementType)(t, 'textarea', { readOnly: !1 }) || (0, j.isContentEditable)(t)) &&
            (0, j.getSpaceUntilMaxLength)(t) !== 0,
        handle: (e, t, r, n) => {
...
`,
                ...
                l = (0, j.isContentEditable)(t) && !n.modifiers.shift ? 'insertParagraph' : 'insertLineBreak'
            ;(0, ft.fireInputEvent)(t, { newValue: a, newSelectionStart: o, eventOverrides: { inputType: l } })
        },
    },
]
...
function k1(e, t) {
    ...
    return {
        ...
        keyCode: (r = e.keyCode) != null ? r : ((n = e.key) == null ? void 0 : n.length) === 1 ? e.key.charCodeAt(0) : void 0,
    }
}
function L1(e) {
    return { altKey: e.modifiers.alt, ctrlKey: e.modifiers.ctrl, metaKey: e.modifiers.meta, shiftKey: e.modifiers.shift }
}
...
const hy = { Alt: 'alt', Control: 'ctrl', Shift: 'shift', Meta: 'meta' },
    F1 = [
        ...
        })),
        {
            ...
            handle: (e, t, r, n) => {
                var a
                const o = (a = r.keyboardMap.find((l) => l.key === 'Control')) != null ? a : { key: 'Control', code: 'Control' }
...
const U1 = [
    ...
    {
        matches: (e, t) => e.key === 'Backspace' && (0, pe.isEditable)(t) && !(0, pe.isCursorAtStart)(t),
        handle: (e, t, r, n) => {
            const { newValue: a, newSelectionStart: o } = (0, pe.calculateNewValue)('', t, n.carryValue, void 0, 'backward')
...
const V1 = [
    {
        matches: (e, t) => e.key === 'Enter' && (0, pe.isElementType)(t, 'input') && ['checkbox', 'radio'].includes(t.type),
        handle: (e, t) => {
            const r = t.form
    ...
    {
        matches: (e, t) => e.key === 'Enter' && ((0, pe.isClickableInput)(t) || ((0, pe.isElementType)(t, 'a') && !!t.href)),
        handle: (e, t, r, n) => {
    ...
    },
    {
        ...
        handle: (e, t) => {
            const r = t.form
            r && (r.querySelectorAll('input').length === 1 || (0, pe.hasFormSubmit)(r)) && ht.fireEvent.submit(r)
        },
    },
]
...
const J1 = [
    {
        matches: (e, t) => e.key === 'selectall' && (0, od.isElementType)(t, ['input', 'textarea']),
        handle: (e, t, r, n) => {
            var a
            ;(0, od.setSelectionRange)(t, 0, ((a = n.carryValue) != null ? a : t.value).length)
        },
    },
]
...
const Q1 = [...K1.keydownBehavior, ...G1.keydownBehavior, ...At.keydownBehavior]
...
async function Ry(e, t, r) {
    ...
    if (
        (d > 1
            ? (r.repeatKey = { consumedLength: 0, keyDef: l, releasePrevious: i, releaseSelf: s, repeat: d - 1 })
            : delete r.repeatKey,
        e.length > u || d > 1)
    )
...
function lx(e, t, r, n) {
    ...
    return n.pressed.push({ keyDef: e, unpreventedDefault: o }), o && Qe(Xe.keydownBehavior, e, t(), r, n), o
}
function ix(e, t, r, n) {
    const a = t()
    Gu.fireEvent.keyPress(a, (0, Yu.getKeyEventProps)(e, n)) && Qe(Xe.keypressBehavior, e, t(), r, n)
}
...
function ux(e, t) {
    var r
    return (((r = e.key) == null ? void 0 : r.length) === 1 || e.key === 'Enter') && !t.modifiers.ctrl && !t.modifiers.alt
}
var pl = {},
    br = {}
...
const sx = [
    ...
    { code: 'Space', key: ' ' },
    { code: 'AltLeft', key: 'Alt', location: de.DOM_KEY_LOCATION.LEFT, keyCode: 18 },
    { code: 'AltRight', key: 'Alt', location: de.DOM_KEY_LOCATION.RIGHT, keyCode: 18 },
    { code: 'ShiftLeft', key: 'Shift', location: de.DOM_KEY_LOCATION.LEFT, keyCode: 16 },
    { code: 'ShiftRight', key: 'Shift', location: de.DOM_KEY_LOCATION.RIGHT, keyCode: 16 },
    { code: 'ControlLeft', key: 'Control', location: de.DOM_KEY_LOCATION.LEFT, keyCode: 17 },
    { code: 'ControlRight', key: 'Control', location: de.DOM_KEY_LOCATION.RIGHT, keyCode: 17 },
    { code: 'MetaLeft', key: 'Meta', location: de.DOM_KEY_LOCATION.LEFT, keyCode: 93 },
    { code: 'MetaRight', key: 'Meta', location: de.DOM_KEY_LOCATION.RIGHT, keyCode: 93 },
    { code: 'OSLeft', key: 'OS', location: de.DOM_KEY_LOCATION.LEFT, keyCode: 91 },
    { code: 'OSRight', key: 'OS', location: de.DOM_KEY_LOCATION.RIGHT, keyCode: 91 },
...
;(function (e) {
    ...
    function l(i, s = {}) {
        ...
        return { promise: (0, r.keyboardImplementation)(i, R, d), state: d, releaseAllKeys: () => (0, r.releaseAllKeys)(R, d) }
    }
    function u() {
        return {
            activeElement: null,
...
async function px(
    e,
    t,
    { delay: r, skipClick: n = !1, skipAutoClose: a = !1, initialSelectionStart: o = void 0, initialSelectionEnd: l = void 0 },
) {
    ...
    const { promise: f, releaseAllKeys: p } = (0, fx.keyboardImplementationWrapper)(t, { delay: r, document: e.ownerDocument })
...
function yx(e, t, { delay: r = 0, ...n } = {}) {
    return r > 0
        ? (0, vx.getConfig)().asyncWrapper(() => (0, ld.typeImplementation)(e, t, { delay: r, ...n }))
        : void (0, ld.typeImplementation)(e, t, { delay: r, ...n }).catch(console.error)
}
var Ju = {}
Object.defineProperty(Ju, '__esModule', { value: !0 })
Ju.clear = bx
...
var Sr = Q,
    ...
    gx = yr
function Ex(e, t, r, n) {
    if ((0, Dt.isDocument)(n) && ((e === 0 && t) || (e === r.length - 1 && !t))) return n.body
    const a = t ? e - 1 : e + 1,
        o = t ? r.length - 1 : 0
    return r[a] || r[o]
}
function _x({ shift: e = !1, focusTrap: t } = {}) {
    var r, n
    const a = (r = (n = t) == null ? void 0 : n.ownerDocument) != null ? r : document,
        o = (0, Dt.getActiveElement)(a)
    t || (t = a)
    const l = t.querySelectorAll(Dt.FOCUSABLE_SELECTOR),
        u = Array.from(l).filter(
            (v) => v === o || (v.getAttribute('tabindex') !== '-1' && !(0, Dt.isDisabled)(v) && (0, Dt.isVisible)(v)),
        )
    ...
    i.forEach((v) => {
        ...
        if (b.type === 'radio' && b.name) {
            ...
            if (b.checked) {
                ;(d = d.filter((w) => w.type !== b.type || w.name !== b.name)), d.push(b), (s[b.name] = b)
                return
            }
    ...
    let R = !0
    o && (e && Sr.fireEvent.keyDown(o, { ...m }), (R = Sr.fireEvent.keyDown(o, { ...C })))
    const S = !R && o ? o : p
...
function Cx(e, t, r, { applyAccept: n = !1 } = {}) {
    ...
    if (!o || !(0, oi.isElementType)(o, 'input', { type: 'file' }))
        throw new TypeError(
            `The ${o === e ? 'given' : 'associated'} ${o == null ? void 0 : o.tagName} element does not accept file uploads`,
        )
    if ((0, oi.isDisabled)(e)) return
    ;(0, Rx.click)(e, r == null ? void 0 : r.clickInit)
    const l = (Array.isArray(t) ? t : [t]).filter((i) => !n || Ox(i, o.accept)).slice(0, o.multiple ? void 0 : 1)
    if (
        ((0, Px.blur)(e),
        (0, wx.focus)(e),
    ...
    ;(0, ai.fireEvent)(o, (0, ai.createEvent)('input', o, { target: { files: u }, bubbles: !0, cancelable: !1, composed: !0 })),
        ai.fireEvent.change(o, { target: { files: u }, ...(r == null ? void 0 : r.changeInit) })
}
function Ox(e, t) {
    if (!t) return !0
    ...
    return t
        .split(',')
        .some((n) =>
            n.startsWith('.') ? e.name.endsWith(n) : r.includes(n) ? e.type.startsWith(n.substr(0, n.length - 1)) : e.type === n,
        )
}
var Ct = {}
...
function wy(e, t, r, n, { skipPointerEventsCheck: a = !1 } = {}) {
        ...
        u = o
            .map((s) => {
                if (typeof s != 'string' && l.includes(s)) return s
                {
                    ...
                    if (d) return d
                    throw (0, M.getConfig)().getElementError(`Value "${String(s)}" not found in options`, t)
                }
            })
    ...
    if ((0, Nt.isElementType)(t, 'select'))
        ...
        } else throw (0, M.getConfig)().getElementError('Cannot select multiple options on a non-multiple select', t)
    ...
    function i(s) {
        ;(s.selected = e),
            (0, M.fireEvent)(t, (0, M.createEvent)('input', t, { bubbles: !0, cancelable: !1, composed: !0, ...n })),
...
var dd = Q,
    be = N
function Tx(e) {
    return ((0, be.isElementType)(e, 'input') && !!be.editableInputTypes[e.type]) || (0, be.isElementType)(e, 'textarea')
}
function qx(e, t, r, { initialSelectionStart: n, initialSelectionEnd: a } = {}) {
    if (!Tx(e))
    ...
    if (
        ...
        e.selectionStart === 0 && e.selectionEnd === 0 && (0, be.setSelectionRange)(e, n ?? e.value.length, a ?? e.value.length),
...
var _ = gd(ln({}, ay), {
    intercept: function (e, t) {
        return t[0] === 'fireEvent' || e.startsWith('findBy') || e.startsWith('waitFor')
    },
})
_.screen = Object.entries(_.screen).reduce(
    function (e, t) {
        var r = t[0],
            n = t[1]
...
try {
    ;(Ji.displayName = 'Page'), (Ji.__docgenInfo = { description: '', displayName: 'Page', props: {} })
} catch {}
const Hx = { title: 'Example/Page', component: Ji, parameters: { layout: 'fullscreen' } },
    $r = {},
    Tr = {
...
$r.parameters = {
    ...
    docs: {
        ...
        source: {
            originalSource: '{}',
            ...((yd = (vd = $r.parameters) == null ? void 0 : vd.docs) == null ? void 0 : yd.source),
        },
    },
}
var md, bd, hd
Tr.parameters = {
  ...
  play: async ({
    ...
    await userEvent.click(loginButton);
            ...
            ...((hd = (bd = Tr.parameters) == null ? void 0 : bd.docs) == null ? void 0 : hd.source),
        },
    },
}
const Wx = ['LoggedOut', 'LoggedIn']
export { Tr as LoggedIn, $r as LoggedOut, Wx as __namedExportsOrder, Hx as default }
//# sourceMappingURL=Page.stories-ea4b3791.js.map
