                    ...
                    children: l
                        ? e.jsxs(e.Fragment, {
                              children: [
                                  e.jsxs('span', {
                                      className: 'welcome',
                                      children: ['Welcome, ', e.jsx('b', { children: l.name }), '!'],
                                  }),
                        ...
                        : e.jsxs(e.Fragment, {
                              children: [
                                  ...
                                  e.jsx(n, { primary: !0, size: 'small', onClick: a, label: 'Sign up' }),
                              ],
                          }),
                }),
            ],
    ...
    ;(r.displayName = 'Header'),
        (r.__docgenInfo = {
            ...
            props: {
                ...
                onLogin: { defaultValue: null, description: '', name: 'onLogin', required: !0, type: { name: '() => void' } },
                onLogout: { defaultValue: null, description: '', name: 'onLogout', required: !0, type: { name: '() => void' } },
                onCreateAccount: {
                    defaultValue: null,
                    description: '',
