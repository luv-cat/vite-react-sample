                ...
                return (
                    ...
                    isArray2(target) && isArray2(source2)
                        ...
                        : Object.keys(source2).reduce(function (acc, key2) {
                              ...
                              return (
                                  has2.call(acc, key2) ? (acc[key2] = merge2(acc[key2], value2, options2)) : (acc[key2] = value2),
                                  acc
                              )
                          }, mergeTarget)
                )
...
function prepareStory(storyAnnotations, componentAnnotations, projectAnnotations) {
    let { moduleExport, id, name: name2 } = storyAnnotations || {},
        ...
        render =
            storyAnnotations?.userStoryFn || storyAnnotations?.render || componentAnnotations.render || projectAnnotations.render
                ...
                entries: Object.fromEntries(
                    Object.entries(this.storyIndex.entries).map(([id, entry]) => [
                        ...
                        stories[id]
                            ...
                            : {
                                  ...entry,
                                  parameters: this.preparedMetaFromCSFFile({ csfFile: cachedCSFFiles[entry.importPath] })
                                      .parameters,
                              },
                    ]),
                ),
