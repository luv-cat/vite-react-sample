try {
    ...
    var ud = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
            for (let o of ad(t))
                !sd.call(e, o) && o !== r && Yo(e, o, { get: () => t[o], enumerable: !(n = od(t, o)) || n.enumerable })
        return e
    }
    var ce = (e, t, r) => (
        (r = e != null ? nd(id(e)) : {}), ud(t || !e || !e.__esModule ? Yo(r, 'default', { value: e, enumerable: !0 }) : r, e)
    )
    var s = Kr(() => {})
    var u = Kr(() => {})
    var l = Kr(() => {})
    ...
    var Rr = E((Yq, np) => {
        ...
        np.exports = function (t, r) {
            ...
            for (var y = 1, v = !0; y < n.length; y += 1) {
                ...
                if (((S === 'constructor' || !v) && (i = !0), (o += '.' + S), (c = '%' + o + '%'), Cr(Ve, c))) p = Ve[c]
                else if (p != null) {
                    if (!(S in p)) {
    ...
    var jp = E((pN, Ip) => {
        ...
        Ip.exports = function e(t, r, n, o) {
            ...
            if (Be(a, 'indent') && a.indent !== null && a.indent !== '	' && !(parseInt(a.indent, 10) === a.indent && a.indent > 0))
            ...
            if (VS(t)) {
                for (var j = '<' + bp.call(String(t.nodeName)), T = t.attributes || [], F = 0; F < T.length; F++)
            ...
            if (BS(t)) {
                ...
                return !('cause' in Error.prototype) && 'cause' in t && !Tp.call(t, 'cause')
                    ? '{ [' + String(t) + '] ' + xe.call(vp.call('[cause]: ' + S(t.cause), q), ', ') + ' }'
                    : q.length === 0
                    ? '[' + String(t) + ']'
                    : '{ [' + String(t) + '] ' + xe.call(q, ', ') + ' }'
            }
            ...
            if (!jS(t) && !_p(t)) {
                var X = Fr(t, S),
                    G = Ep ? Ep(t) === Object.prototype : t instanceof Object || t.constructor === Object,
...
` +
            ...
            for (var i in e)
                Be(e, i) &&
                    ((r && String(Number(i)) === i && i < e.length) ||
                        ...
                        (Cp.call(/[^\w$]/, i) ? n.push(t(i, e) + ': ' + t(e[i], e)) : n.push(i + ': ' + t(e[i], e))))
            if (typeof Qn == 'function')
                for (var d = 0; d < a.length; d++) Tp.call(e, a[d]) && n.push('[' + t(a[d]) + ']: ' + t(e[a[d]], e))
            return n
        }
    })
    var qp = E((yN, Bp) => {
            ...
            yE = function (t, r, n, o, a) {
                ...
                for (var p = '', i = 0; i < c.length; ++i) {
                    ...
                    ;(i += 1),
                        ...
                        (p += _e[240 | (d >> 18)] + _e[128 | ((d >> 12) & 63)] + _e[128 | ((d >> 6) & 63)] + _e[128 | (d & 63)])
                }
                return p
            },
            mE = function (t) {
            ...
            _E = function e(t, r, n, o, a, c, p, i, d, y, v, S, x, _, R, j) {
                ...
                for (var Z = o && Fe(T) && T.length === 1 ? r + '[]' : r, ee = 0; ee < G.length; ++ee) {
                    ...
                    if (!(c && N === null)) {
                        ...
                        var w = zp()
                        w.set(ho, j),
                            Up(X, e(N, A, n, o, a, c, n === 'comma' && _ && Fe(T) ? null : p, i, d, y, v, S, x, _, R, w))
                    }
                }
                return X
            },
            ...
            FE = function (t, r) {
                ...
                if (r.charsetSentinel)
                    for (i = 0; i < c.length; ++i)
                        c[i].indexOf('utf8=') === 0 &&
                            (c[i] === DE ? (d = 'utf-8') : c[i] === RE && (d = 'iso-8859-1'), (p = i), (i = c.length))
                for (i = 0; i < c.length; ++i)
                    if (i !== p) {
                        var y = c[i],
                            v = y.indexOf(']='),
                            ...
                            _
                        S === -1
                            ? ((x = r.decoder(y, oe.decoder, d, 'key')), (_ = r.strictNullHandling ? null : ''))
            ...
            jE = function (t) {
                ...
                return {
                    ...
                    interpretNumericEntities:
                        typeof t.interpretNumericEntities == 'boolean' ? t.interpretNumericEntities : oe.interpretNumericEntities,
    ...
    var ld = Object.create,
        ...
        dd = (e, t, r, n) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
                for (let o of Xo(t))
                    !fd.call(e, o) && o !== r && Ko(e, o, { get: () => t[o], enumerable: !(n = cd(t, o)) || n.enumerable })
            return e
        },
        ge = (e, t, r) => (
            (r = e != null ? ld(pd(e)) : {}), dd(t || !e || !e.__esModule ? Ko(r, 'default', { value: e, enumerable: !0 }) : r, e)
        )
    s()
    u()
    l()
    ...
    var Nd = Object.create,
        ...
        $d = (e, t, r, n) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
                for (let o of la(t))
                    !Md.call(e, o) && o !== r && ua(e, o, { get: () => t[o], enumerable: !(n = Ld(t, o)) || n.enumerable })
            return e
        },
        ca = (e, t, r) => (
            (r = e != null ? Nd(kd(e)) : {}), $d(t || !e || !e.__esModule ? ua(r, 'default', { value: e, enumerable: !0 }) : r, e)
        )
    function pa() {
        ...
        var o = n.reduce(function (p, i) {
            ...
            return d
                ? p.concat(
                      d.map(function (y) {
                          var v, S
                          return (S = (v = y.match(/[\t ]/g)) === null || v === void 0 ? void 0 : v.length) !== null &&
                              S !== void 0
                              ? S
                              : 0
                      }),
...
`)),
    ...
    var i1 = Object.create,
        ...
        f1 = (e, t, r, n) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
                for (let o of u1(t))
                    !c1.call(e, o) && o !== r && bc(e, o, { get: () => t[o], enumerable: !(n = s1(t, o)) || n.enumerable })
            return e
        },
        d1 = (e, t, r) => (
            (r = e != null ? i1(l1(e)) : {}), f1(t || !e || !e.__esModule ? bc(r, 'default', { value: e, enumerable: !0 }) : r, e)
        ),
        h1 = p1((e) => {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
    ...
    var QE = Object.create,
        ...
        rA = (e, t, r, n) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
                for (let o of tf(t))
                    !tA.call(e, o) && o !== r && ef(e, o, { get: () => t[o], enumerable: !(n = ZE(t, o)) || n.enumerable })
            return e
        },
        kr = (e, t, r) => (
            (r = e != null ? QE(eA(e)) : {}), rA(t || !e || !e.__esModule ? ef(r, 'default', { value: e, enumerable: !0 }) : r, e)
        ),
        nA = [
            'bubbles',
            'cancelBubble',
                ...
                t.exports = function (N, A) {
                    ...
                    for (var re = 1, be = !0; re < w.length; re += 1) {
                        var le = w[re],
                            ve = V(le, 0, 1),
                            Ze = V(le, -1)
                        if ((ve === '"' || ve === "'" || ve === '`' || Ze === '"' || Ze === "'" || Ze === '`') && ve !== Ze)
                            throw new n('property names with quotes must have matching quotes')
                        if (((le === 'constructor' || !be) && (I = !0), (C += '.' + le), (O = '%' + C + '%'), F(_, O))) D = _[O]
                        else if (D != null) {
                            if (!(le in D)) {
...
` &&
    ...
    u()
    l()
    var $ = ((e) => ((e.DONE = 'done'), (e.ERROR = 'error'), (e.ACTIVE = 'active'), (e.WAITING = 'waiting'), e))($ || {}),
        Le = {
    ...
    function t_(e) {
        ...
        return (
            (p *= 60),
            e.alpha !== void 0 ? { hue: p, saturation: d, lightness: c, alpha: e.alpha } : { hue: p, saturation: d, lightness: c }
        )
    }
    function Me(e) {
        return t_(xt(e))
    ...
    var Uo = (e) => Array.isArray(e) || (ArrayBuffer.isView(e) && !(e instanceof DataView)),
        ...
        rO = ['theme', 'hover', 'colorScheme', 'children', 'label', 'className', 'onUpdate', 'onSelect', 'open'],
        Wr = (e) => {
            let {
                    theme: t,
                    hover: r,
            ...
            if (!N)
                return h.createElement(
                    'ul',
                    (0, jo.default)(
                        { role: 'tree', tabIndex: 0, className: Ce(fe.tree, fe.group, v, c), onFocus: Z, onBlur: J },
                        y,
                    ),
    ...
    var Wf = Gf,
        ...
        Vf = (e) => {
            ...
            return t.type === 'array'
                ? h.createElement('span', (0, Ot.default)({ className: v }, p), h.createElement(x, null), uO(t, o, n, d))
                : t.type === 'function'
                ? h.createElement(
                      'span',
                ...
                : t.type === 'promise'
                ? h.createElement('span', (0, Ot.default)({ className: v }, p), h.createElement(x, null), cO(t, o, n))
                : t.type === 'map'
                ? h.createElement('span', (0, Ot.default)({ className: v }, p), h.createElement(x, null), pO(t, o, n, d))
                : t.type === 'set'
                ? h.createElement('span', (0, Ot.default)({ className: v }, p), h.createElement(x, null), fO(t, o, n))
                : h.createElement('span', (0, Ot.default)({ className: v }, p), h.createElement(x, null), lO(t, o, n, d))
        }
    ...
    var hO = Ho,
        yO = ['data', 'expandLevel', 'sortKeys', 'includePrototypes', 'className', 'theme', 'colorScheme', 'onSelect'],
        Yf = (e) => {
            let {
                    data: t,
                    expandLevel: r,
    ...
    var mO = {
        ...
        OO = ({ showInspector: e, value: t, nested: r = !1 }) => {
            ...
            return Object.keys(t).length <= 2
                ...
                : h.createElement('span', { style: { color: o.base } }, '(', Object.keys(t).length, ') ', '{ ', a, ', \u2026 }')
        },
        CO = ({ name: e }) => {
            let t = ae()
        ...
        FO = ({ name: e, message: t }) => {
            ...
            return h.createElement(
                ...
                e,
                t && ': ',
                t && h.createElement('span', { style: { color: r.error.message }, title: t.length > 50 ? t : '' }, Kf(t, 50)),
            )
        },
        PO = ({ flags: e, source: t }) => {
            let r = ae()
...
`)
        ...
        GO = H('div', { shouldForwardProp: (e) => !['call', 'pausedAt'].includes(e.toString()) })(
            ({ theme: e, call: t }) => ({
                position: 'relative',
                display: 'flex',
...
`),
                ...
                : z(
                      ...
                      z(
                          ...
                          z(
                              ...
                              z(HO, { style: { marginLeft: 6, marginBottom: 1 } }, z(Go, { call: e, callsById: t })),
                          ),
                          z(
                              YO,
                              null,
                              o?.length > 0 &&
                                  z(
                                      Xe,
                                      { hasChrome: !1, tooltip: z(XO, { note: `${c ? 'Show' : 'Hide'} interactions` }) },
                                      z(KO, { containsIcon: !0, onClick: p }, z(ke, { icon: 'listunordered' })),
                                  ),
                          ),
                      ),
                      e.status === $.ERROR && e.exception?.callId === e.id && z(QO, { exception: e.exception }),
                  )
        },
        ...
        tC = H.div(({ theme: e }) => ({ padding: 15, fontSize: e.typography.size.s2 - 1, lineHeight: '19px' })),
        rC = H.code(({ theme: e }) => ({
            margin: '0 1px',
            padding: 3,
        ...
        aC = H.pre(({ theme: e }) => ({ margin: 0, padding: 0, fontSize: e.typography.size.s1 - 1 })),
        iC = ea(function ({
            calls: e,
            controls: t,
            controlStates: r,
