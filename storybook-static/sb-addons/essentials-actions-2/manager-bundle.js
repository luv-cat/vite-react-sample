try {
    ...
    var st = Object.create,
        ...
        dt = (e, t, r) => (
            (r = e != null ? st(ut(e)) : {}), pt(t || !e || !e.__esModule ? se(r, 'default', { value: e, enumerable: !0 }) : r, e)
        ),
        mt = le({
    ...
    var ie = ({ data: e }) => {
        ...
        Ct = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
            e === 0 ? a.createElement(Rt, { name: t, data: r }) : a.createElement(St, { name: t, data: r, isNonenumerable: n }),
    ...
    function rr(e) {
        ...
        return (
            (s *= 60),
            e.alpha !== void 0 ? { hue: s, saturation: c, lightness: u, alpha: e.alpha } : { hue: s, saturation: c, lightness: u }
        )
    }
    function x(e) {
        return rr(M(e))
    ...
    var Ar = k.div({
        ...
        Lr = Fe(({ theme: e, ...t }) => a.createElement(qe, { theme: e.addonActionsTheme || 'chromeLight', table: !1, ...t })),
