...
function getClassNameCombinations(classNames) {
    ...
    return (
        classNameCombinations[key] || (classNameCombinations[key] = powerSetPermutations(classNames)), classNameCombinations[key]
    )
}
...
var ActionBar = ({ actionItems, ...props }) =>
    ...
    Scroller = ({ horizontal, vertical, ...props }) =>
        import_react.default.createElement(
            ...
            import_react.default.createElement(OverlayScrollbars, { options: { scrollbars: { autoHide: 'leave' } }, ...props }),
        ),
...
var Wrapper = emotion_styled_browser_esm_default.div(
    ...
    SyntaxHighlighter2 = ({
        ...
        return import_react.default.createElement(
            ...
            copyable
                ? import_react.default.createElement(ActionBar, { actionItems: [{ title: copied ? 'Copied' : 'Copy', onClick }] })
                : null,
        )
    },
