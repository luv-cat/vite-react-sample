...
var PolishedError = (function (_Error) {
    ...
    function PolishedError2(code) {
        ...
        return (
            (_this = _Error.call(this, format.apply(void 0, [ERRORS[code]].concat(args))) || this), _assertThisInitialized(_this)
        )
    }
...
var curriedTransparentize = curry(transparentize),
    ...
    isColorString = (color2) =>
        typeof color2 != 'string'
            ? (logger.warn(`Color passed to theme object should be a string. Instead ${color2}(${typeof color2}) was passed.`),
              !1)
            : !0,
...
var isBrowser2,
    ...
    composeShouldForwardProps = function (tag, options, isReal) {
        ...
        return (
            typeof shouldForwardProp != 'function' && isReal && (shouldForwardProp = tag.__emotion_forwardProp), shouldForwardProp
        )
    },
