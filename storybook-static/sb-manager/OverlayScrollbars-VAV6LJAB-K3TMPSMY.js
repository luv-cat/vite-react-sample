                        ...
                        function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                            ...
                            function update(updateHints) {
                                ...
                                if (
                                    ...
                                    force &&
                                        ...
                                        (displayIsHidden =
                                            displayIsHidden === undefined2 ? _hostElement.is(':hidden') : displayIsHidden)
                            ...
                            function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
                                var transition = type(scrollOrTransition) == TYPES.b,
                                    ...
                                    currentScroll =
                                        scrollOrTransition === undefined2 || transition ? nativeScroll : scrollOrTransition,
                                    handleLength = scrollbarVarsInfo._handleLength,
                            ...
                            function getHostElementInvertedScale() {
                                ...
                                return {
                                    x:
                                        (_supportTransform && 1 / (MATH.round(rect.width) / _paddingElementNative[LEXICON.oW])) ||
                                        1,
                                    y:
                                        (_supportTransform &&
